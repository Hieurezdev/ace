...
RESULTS_ROOT="${RESULTS_ROOT:-results/curator_full_operations_adversarial_verified}"
...
run_experiment() {
  ...
  echo ">>> Running ${task_name} / full_operations_adversarial_verified"
...
echo ">>> Full curator operations + verified adversarial completed: ${RESULTS_ROOT}"
